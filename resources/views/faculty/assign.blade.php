...
@section('content')
	<h2><img src="{{ asset('images/st-therese-logo.jpg') }}"> Faculty <a href="{{ route('faculty.show', $facs->user->id) }}" class="btn btn-default pull-right">Go Back</a></h2>
		<hr>
                ...
                <div class="modal-body">
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							{{ Form::text('student_id', $student->id, ['class' => 'no-border sub', 'readonly']) }}
							<tr>
								...
								<td>{{ Form::text('course', $student->course, ['class' => 'no-border0', 'readonly']) }}</td>
								<td>{{ Form::text('year', $student->year, ['class' => 'no-border0', 'readonly']) }}</td>
