...
@section('content')
	...
	<div class="btn-group btn-group-justified">
	  ...
	  <a href="{{ route('tesdaassign.show', $users->id) }}" class="btn btn-default active"><img id="btn-group-img" src="{{ asset('images/tesda-logo.png') }}"> <strong>TESDA</strong></a>
	</div>
	<br>
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ Form::text('subject_code', $subject->subject_code, ['class' => 'no-border3', 'readonly']) }}</td>
									...
									<td><a href="#" data-toggle="modal" data-target="#tesdaassign-{{ $subject->id }}" class="btn btn-success btn-block">Assign</a> </td>
								</tr>

								<!-- Subject Assign Modal -->
								<div class="modal modal-center" id="tesdaassign-{{ $subject->id }}" tabindex="-1">
