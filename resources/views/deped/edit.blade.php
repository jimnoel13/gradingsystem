...
@section('content')
	<h2><img src="{{ asset('images/deped-logo.png') }}"> DepEd</h2>
	<br>
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr>
				{!! Form::open(['route' => ['deped.update', $subjects->id], 'method' => 'POST']) !!}
				<td></td>
				...
				<td><a href="{{ route('deped.index') }}" class="btn btn-default">Cancel</a>
