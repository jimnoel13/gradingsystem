...
@section('content')
	<h2><img src="{{ asset('images/deped-logo.png') }}"> DepEd <a href="#" data-toggle="modal" data-target="#adddeped" class="btn btn-primary pull-right"><span class="fa fa-plus"></span> Create Subject</a></h2>
	<br>
	...
	<table class="table table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td>{!! Form::open(['action'=>['DepEdController@destroy', $subject->id],'method'=>'POST']) !!}
		        ...
		        <div class="modal-dialog">
		            <div class="modal-content">
		                ...
		                <div class="modal-body">
		                	{!! Form::open(['action' => ['DepEdController@update', $subject->id], 'method' => 'POST']) !!}
	...
	<div class="modal modal-center" id="adddeped">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                	{!! Form::open(['action' => 'DepEdController@store', 'method' => 'POST']) !!}

					<!-- School Department -->
					{{ Form::text('school_dept', 'DepEd', ['class' => 'sub']) }}
